if(localStorage.getItem('uploadedImage3') != null){
    window.addEventListener('load', function() {
        ...
        pic.setAttribute('src', localStorage.getItem('uploadedImage3'));
        ...
        h3.appendChild(document.createTextNode('Bird'));
        var h5=document.createElement("h5");
        h5.appendChild(document.createTextNode('RS:2000'));
