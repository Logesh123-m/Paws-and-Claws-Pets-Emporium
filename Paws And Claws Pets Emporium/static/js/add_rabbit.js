if(localStorage.getItem('uploadedImage4') != null){
    window.addEventListener('load', function() {
        ...
        pic.setAttribute('src', localStorage.getItem('uploadedImage4'));
        ...
        h3.appendChild(document.createTextNode('Rabbit'));
        var h5=document.createElement("h5");
        h5.appendChild(document.createTextNode('RS:1200'));
